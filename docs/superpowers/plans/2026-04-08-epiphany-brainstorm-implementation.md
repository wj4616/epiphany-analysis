# Epiphany Brainstorm Skill Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create the `epiphany-brainstorm` skill file at `~/.claude/skills/epiphany-brainstorm/SKILL.md` following the validated design spec.

**Architecture:** Single-file skill with frontmatter, trigger conditions, hard gates, pipeline stages, methodology content, output schema, edge cases, and file save behavior. No external runtime dependencies — all methodology content inlined.

**Tech Stack:** Markdown SKILL.md file with YAML frontmatter. Follows pattern of `prompt-epiphany` and `brainstorming-epiphany` skills.
...
```
~/.claude/skills/epiphany-brainstorm/
└── SKILL.md          # Single skill file (the only deliverable)
```

---

## Task 1: Create Directory and SKILL.md Skeleton

**Files:**
- Create: `~/.claude/skills/epiphany-brainstorm/SKILL.md`

- [ ] **Step 1: Create the skill directory**

```bash
mkdir -p ~/.claude/skills/epiphany-brainstorm
```

- [ ] **Step 2: Write the SKILL.md frontmatter and opening sections**

Create `~/.claude/skills/epiphany-brainstorm/SKILL.md` with:
...
```bash
git add ~/.claude/skills/epiphany-brainstorm/SKILL.md
git commit -m "feat: create epiphany-brainstorm SKILL.md skeleton"
```

---

## Task 2: Add Trigger Conditions

**Files:**
- Modify: `~/.claude/skills/epiphany-brainstorm/SKILL.md`

- [ ] **Step 1: Add Trigger Conditions section after Scope boundary**
...
- [ ] **Step 2: Commit trigger conditions**

```bash
git add ~/.claude/skills/epiphany-brainstorm/SKILL.md
git commit -m "feat: add trigger conditions to epiphany-brainstorm"
```

---

## Task 3: Add Hard Gates Section
...
- [ ] **Step 2: Commit hard gates**

```bash
git add ~/.claude/skills/epiphany-brainstorm/SKILL.md
git commit -m "feat: add hard gates to epiphany-brainstorm"
```

---

## Task 4: Add Pipeline Overview Section

**Files:**
- Modify: `~/.claude/skills/epiphany-brainstorm/SKILL.md`

- [ ] **Step 1: Add Pipeline Overview section**
...
- [ ] **Step 2: Commit pipeline overview**

```bash
git add ~/.claude/skills/epiphany-brainstorm/SKILL.md
git commit -m "feat: add pipeline overview to epiphany-brainstorm"
```

---

## Task 5: Add Scale Router Section

**Files:**
- Modify: `~/.claude/skills/epiphany-brainstorm/SKILL.md`

- [ ] **Step 1: Add Scale Router section**
...
- [ ] **Step 2: Commit scale router**

```bash
git add ~/.claude/skills/epiphany-brainstorm/SKILL.md
git commit -m "feat: add scale router to epiphany-brainstorm"
```

---

## Task 6: Add Lens Firewall Mechanics Section

**Files:**
- Modify: `~/.claude/skills/epiphany-brainstorm/SKILL.md`

- [ ] **Step 1: Add Lens Firewall Mechanics section**
...
- [ ] **Step 2: Commit firewall mechanics**

```bash
git add ~/.claude/skills/epiphany-brainstorm/SKILL.md
git commit -m "feat: add lens firewall mechanics to epiphany-brainstorm"
```

---

## Task 7: Add Stage Specifications (S1–S3)

**Files:**
- Modify: `~/.claude/skills/epiphany-brainstorm/SKILL.md`

- [ ] **Step 1: Add Stage Specifications header and S1–S3**
...
- [ ] **Step 2: Commit S1–S3 specifications**

```bash
git add ~/.claude/skills/epiphany-brainstorm/SKILL.md
git commit -m "feat: add S1–S3 stage specifications to epiphany-brainstorm"
```

---

## Task 8: Add Stage Specifications (S4–S6 and Synthesis)

**Files:**
- Modify: `~/.claude/skills/epiphany-brainstorm/SKILL.md`

- [ ] **Step 1: Add S4, S5, Synthesis, and S6 specifications**
...
- [ ] **Step 2: Commit S4–S6 specifications**

```bash
git add ~/.claude/skills/epiphany-brainstorm/SKILL.md
git commit -m "feat: add S4–S6 and synthesis stage specifications to epiphany-brainstorm"
```

---

## Task 9: Add Methodology Curation Section

**Files:**
- Modify: `~/.claude/skills/epiphany-brainstorm/SKILL.md`

- [ ] **Step 1: Add Methodology Curation section**
...
- [ ] **Step 2: Commit methodology curation**

```bash
git add ~/.claude/skills/epiphany-brainstorm/SKILL.md
git commit -m "feat: add methodology curation section to epiphany-brainstorm"
```

---

## Task 10: Add Validation Gates Section

**Files:**
- Modify: `~/.claude/skills/epiphany-brainstorm/SKILL.md`

- [ ] **Step 1: Add Validation Gates section**
...
- [ ] **Step 2: Commit validation gates**

```bash
git add ~/.claude/skills/epiphany-brainstorm/SKILL.md
git commit -m "feat: add validation gates section to epiphany-brainstorm"
```

---

## Task 11: Add Output Format Section
...
```bash
git add ~/.claude/skills/epiphany-brainstorm/SKILL.md
git commit -m "feat: add output format section to epiphany-brainstorm"
```

---

## Task 12: Add External Compatibility, Edge Cases, File Save, Quality Standard

**Files:**
- Modify: `~/.claude/skills/epiphany-brainstorm/SKILL.md`

- [ ] **Step 1: Add remaining sections (External Compatibility, Edge Cases, File Save, Quality Standard)**
...
- [ ] **Step 2: Commit all remaining sections**

```bash
git add ~/.claude/skills/epiphany-brainstorm/SKILL.md
git commit -m "feat: add external compatibility, edge cases, file save, and quality standard to epiphany-brainstorm"
```

---

## Task 13: Final Verification and Self-Review

**Files:**
- Verify: `~/.claude/skills/epiphany-brainstorm/SKILL.md`

- [ ] **Step 1: Verify spec coverage**

Read through the design spec at `docs/superpowers/specs/2026-04-08-epiphany-brainstorm-skill-design.md` and confirm:
- [ ] All MH-1 through MH-10 requirements addressed
- [ ] All SH-1 through SH-3 should-haves addressed
- [ ] All NR-1 through NR-3 non-requirements honored
- [ ] All V1-V14 verification checks passable

- [ ] **Step 2: Run self-review checklist**

From the writing-plans skill:
- [ ] Placeholder scan: No TBD, TODO, "implement later", or vague requirements
- [ ] Type consistency: All function names, property names, and terms are consistent throughout
- [ ] All code blocks show actual content, not "similar to Task N"
...
git add ~/.claude/skills/epiphany-brainstorm/SKILL.md
git commit -m "fix: resolve self-review issues in epiphany-brainstorm skill"
```
...
Plan complete. The implementation creates a single file:

```
~/.claude/skills/epiphany-brainstorm/SKILL.md
```
